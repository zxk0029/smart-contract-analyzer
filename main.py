...
async def main(quick_mode: bool = True):
    """主程序入口"""
    try:
        # 基本信息分析
...
if __name__ == "__main__":
    ...
    # python main.py --quick 使用快速检查模式
    # python main.py --contract 0x1f9840a85d5aF5bf1D1762F925BDADdC4201F984 根据传入的合约，检测，eth
    # python main.py --contract 0xBF6Cd8D57ffe3CBe3D78DEd8DA34345A3B736102 根据传入的合约，检测，bsc
    import argparse 
